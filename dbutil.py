...
def lookup_course(db, subject, code, suffix=''):
    ...
    '''
    pie_js3 = '''
    var options = {title: 'Percentage Breakdown', colors: ['#99CBE5', '#A2D4D5', '#F8DED8', '#F8B5BB', '#A69C94', '#99CBE5', '#A2D4D5', '#F8DED8', '#F8B5BB', '#A69C94']};var chart = new google.visualization.PieChart(document.getElementById('piechart'));chart.draw(data, options);}
    </script>
    <div style='float:cen;clear:both;'><div id='piechart' style='width: 500px; height: 300px; float:left;clear:left;'></div>
    </div>
    '''
